class AccountModel {
  ...
  AccountModel copyWith({int id, String token, int created, int expiresIn}) =>
      AccountModel(id ?? this.id, token ?? this.token,
          expiresIn ?? this.expiresIn, created ?? this.created);
  ...
  factory AccountModel.fromJson(Map<String, dynamic> json) {
    ...
    return AccountModel(
        json['id'], json['token'], json['expiresIn'], json['created']);
  }
